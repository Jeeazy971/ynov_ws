...
const sequelize = new sequelize_1.Sequelize(process.env.DB_DATABASE || 'postgres', // Default value if not set
process.env.DB_USERNAME || 'postgres', process.env.DB_PASSWORD || '', {
